...
public class YPolicyfilterVO {
	...
	public YPolicyfilterVO() {}; // 기본 생성자 추가
	
	public YPolicyfilterVO(String yP_ID, String yP_NAME, String yP_PI, String yP_INFO, String yP_CATEGORY, String yP_SSIZE,
	...
	public String toString() {
		return "YPolicyVO [YP_ID=" + YP_ID + ", YP_NAME=" + YP_NAME + ", YP_PI=" + YP_PI + ", YP_INFO=" + YP_INFO
				...
				+ YP_REGION + ", YP_VIEW=" + YP_VIEW + ", filtertext=" + filtertext + ", filter=" + filter + "]";
	}
}
